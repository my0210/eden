...
exports.appleHealthMappings = void 0;
exports.buildHkTypeToMappingLookup = buildHkTypeToMappingLookup;
exports.getAllHkTypes = getAllHkTypes;
/**
 * Apple Health mappings for v2-supported metrics.
 */
exports.appleHealthMappings = [
    // VO2 Max
    {
        metric_code: 'vo2max',
 ...
 */
function buildHkTypeToMappingLookup() {
    const lookup = new Map();
    for (const mapping of exports.appleHealthMappings) {
